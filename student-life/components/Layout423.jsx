      ...
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">
            State-of-the-art facilities for cricket, football, and athletics to
            foster teamwork and physical excellence.
          </p>
        </div>
              ...
              <div className="z-10">
                ...
                <div className="lg:hidden">
                  <p className="mt-5 text-text-alternative md:mt-6">
                    Nurturing creativity through drama, fine arts, and musical
