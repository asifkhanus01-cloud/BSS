            ...
            <div className="px-[5%]">
              <div className="container">
                <a href="#" className="flex h-16 w-full items-center underline">
                  ...
                  <h1 className="font-semibold md:text-md">About the role</h1>
                </a>
                  ...
                  <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                    <div>
                      ...
                      <p className="md:text-md">
                        We seek an experienced mathematics educator to develop
                        and deliver our secondary curriculum. You will work with
                        students from grades nine through twelve, fostering
                        analytical thinking and mathematical confidence.
                      </p>
                      <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
                        <Button title="Expand" variant="secondary">
                          Expand
                        </Button>
                        <Button
                          title="Details"
            ...
            <div className="px-[5%]">
              <div className="container">
                <a href="#" className="flex h-16 w-full items-center underline">
                  ...
                  <h1 className="font-semibold md:text-md">What we offer</h1>
                </a>
                <div className="py-8 md:py-10 lg:py-12">
                  <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                    <div>
