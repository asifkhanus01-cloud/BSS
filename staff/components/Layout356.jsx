            ...
            <div className="px-[5%]">
              <div className="container">
                <a href="#" className="flex h-16 w-full items-center underline">
                  ...
                  <h1 className="font-semibold md:text-md">Advanced degrees</h1>
                </a>
                  ...
                  <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                    <div>
                      ...
                      <h2 className="rb-5 mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
                        Master's degrees and specialized certifications
                      </h2>
                      <p className="md:text-md">
                        Our faculty holds advanced qualifications from
                        recognized institutions. Each educator brings
                        specialized expertise in their subject area and
                        pedagogical methods.
                      </p>
